  ...
  return (
    <section>
      <Element name='pricing'>
        ...
        <div className='max-w-960 pricing-head_before  mx-auto border-l border-r border-s2 bg-s1/50 pb-40 pt-28 max-xl:max-w-4xl max-lg:border-none max-md:pb-32 max-md:pt-16'>
        ...
        <div className='scroll-hide relative z-2 -mt-12 flex items-start max-xl:gap-5 max-xl:overflow-auto max-xl:pt-6'>
          {plans.map((plan, index) => (
            <div key={plan.id} className='pricing-plan_first pricing-plan_last pricing-plan_odd pricing-plan_even relative border-2 p-7 max-xl:min-w-80 max-lg:rounded-3xl xl:w-[calc(33.33% + 2px)]'>
              ...
              <div className={clsx('small-2 rounded-20 relative z-2 mx-auto mb-6 border-2 px-4 py-1.5 uppercase', index === 1 ? 'border-p2 text-p3' : 'border-p1 text-p1')}>
                {plan.title}
              ...
              <div className='relative z-2 flex items-center justify-center '>
                ...
                <div className='small-1 relative top-3 ml-1 upppercase'>
                  / mo
                </div>
              </div>
